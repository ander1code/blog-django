...
class frmBlog(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['titulo'].error_messages['max_length'] = 'Titulo esta com mais de 100 caracteres.'
        self.fields['texto'].error_messages['required'] = 'Texto esta vazio.'
        self.fields['texto'].error_messages['max_length'] = 'Titulo esta com mais de 600 caracteres.'
